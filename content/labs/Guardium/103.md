...
- Demonstrates Vulnerability Assessment functions that help identify and correct security
    vulnerabilities in database infrastructure.
- Provide details about policy management that helps monitor and audit traffic.
...
![](./images/103/image-001.jpg)

![](./images/103/image-002.jpg)
...
![](./images/103/image-011.png)

- Click **Filter/Sort** Controls.

![](./images/103/image-012.png)
...
![](./images/103/image-029.png)

- Review the Rule definition and expand the **Rule criteria** section.

![](./images/103/image-030.jpg)
