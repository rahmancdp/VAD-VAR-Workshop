...
- Scroll down and click Back to return to the assessment builder. Then click Back again to
    return to the assessment finder.


- Select your new assessment and click Run Once Now.


- Close the dialog and wait a moment. You can optionally access the Guardium Job Queue


to show the progress.

- Return to the assessment builder. Select your assessment and click View Results. A new


report window opens. Adjust the size of the window as necessary.
...
- Log into C200 as `labadmin` for policy and reporting exercises. You must do this from the
...
- Enter Lab PCI Policy as the name.
...
- To return to policy, scroll down and click Cancel. Select the 4 th rule, SQL Error – Alert on


Risk Indicative errors and click Edit (Pencil).
