...
This lab showcases the Smart Assistant functions, which helps quickly configure
    monitoring for GDPR, PCI, SOX, and other security standards and regulations.
This lab showcases the Risk Spotter that uses a holistic algorithm to dynamically assess risk factors, and
    to identify potential risks across the entire system.
This lab demonstrate the Active Threat Analytics dashboard that shows potential security breach
    cases, based on the outlier mining process and on identified attack symptoms.
...
- On the navigation menu, click **Setup > Smart Assistant > Compliance Health Monitor**
