...
<br />![instances_page](../images/204/watsonxgov-l4_instances_page.png)
...
<br />![manage_access](../images/204/watsonxgov-l4_manage_access.png)
...
<br />![grant_access_modal](../images/204/watsonxgov-l4_grant_access_modal.png)
...
<br />![instances_name](../images/204/watsonxgov-l4_openpages_instance_name.png)

6. Scroll down to the **Access** information section, and click the **launch icon** to launch the service.

<br />![instances_name](../images/204/watsonxgov-l4_launch_openpages.png)
...
<br />![config_users](../images/204/watsonxgov-l4_config_users.png)
...
<br />![created_user_table](../images/204/watsonxgov-l4_created_user.png)
...
<br />![edit_profiles](../images/204/watsonxgov-l4_edit_profiles.png)
...
<br />![add_profiles](../images/204/watsonxgov-l4_profiles.png)
...
<br />![assign_roles](../images/204/watsonxgov-l4_assign_roles.png)
...
<br />![mrg_roles](../images/204/watsonxgov-l4_mrg_new_roles.png)
...
<br />![mrg_roles](../images/204/watsonxgov-l4_roles_choose_option.png)
...
<br />![high_oaks_bank_mrg](../images/204/watsonxgov-l4_high_oaks.png)
...
<br />![business_entities](../images/204/watsonxgov-l4_business_entities.png)
...
<br />![high_oaks_entity](../images/204/watsonxgov-l4_high_oaks_entity.png)
...
<br />![child_entities](../images/204/watsonxgov-l4_highoaks_expand_tree.png)
...
<br />![corporate_tile](../images/204/watsonxgov-l4_corporate_tile.png)
...
<br />![hr_entity](../images/204/watsonxgov-l4_human_resources.png)

10. Scroll back to the **Child Business Entity** table and click the **New Business Entity** button.

<br />![hr_entity](../images/204/watsonxgov-l4_new_business_entity.png)
...
<br />![config_users](../images/204/watsonxgov-l4_new_entity_details.png)
...
<br />![sys_admin_mode](../images/204/watsonxgov-l4_enable_admin.png)
...
<br />![object_types](../images/204/watsonxgov-l4_object_types.png)
...
<br />![use_case_types](../images/204/watsonxgov-l4_use_case_type.png)
...
<br />![new_field_types](../images/204/watsonxgov-l4_new_field.png)
...
<br />![new_field_group](../images/204/watsonxgov-l4_new_field_group.png)
...
<br />![new_field_details](../images/204/watsonxgov-l4_new_field_details.png)
...
<br />![new_enum_value](../images/204/watsonxgov-l4_new_enum_value.png)
...
<br />![create_field](../images/204/watsonxgov-l4_create_field.png)
...
<br />![error_field_exists](../images/204/watsonxgov-l4_field_def_exists.png)
...
<br />![disable_sys_admin](../images/204/watsonxgov-l4_disable_admin.png)
...
<br />![use-case-inventory](../images/204/watsonxgov-l4_use_cases_inventory.png)
...
<br />![display_debug_info](../images/204/watsonxgov-l4_display_debug.png)

> A link will appear beneath the name of the use case, identifying the view as _watsonx-governance-Task-Register_.

<Warning text='If the default view name shows as _SysView-Task-Register_, then the admin user is not using the correct profile. Go back and follow the steps for _Enable on the watsonx profiles for the admin user_ instructions from the configuration steps of this lab in order to ensure that the watsonx profiles are assigned, and that the admin user has changed to one of those profiles.' />

8. Click the link for **watsonx-governance-Task-Register** to open the view in a new tab.

<br />![view_name_link](../images/204/watsonxgov-l4_view_name_link.png)
...
<br />![copy_view](../images/204/watsonxgov-l4_copy_view.png)
...
<br />![view_name](../images/204/watsonxgov-l4_view_name.png)
...
<br />![use_default_view](../images/204/watsonxgov-l4_use_as_default.png)
...
<br />![drag_view](../images/204/watsonxgov-l4_drag_review.png)
...
<br />![drag_grid](../images/204/watsonxgov-l4_drag_grid.png)
...
<br />![relationship](../images/204/watsonxgov-l4_relationship.png)
...
<br />![add_fields](../images/204/watsonxgov-l4_add_fields.png)
...
<br />![add_fields](../images/204/watsonxgov-l4_stakeholder_depts.png)
...
<br />![publish_views](../images/204/watsonxgov-l4_publish_view.png)
...
<br />![config_views](../images/204/watsonxgov-l4_config_views.png)
...
<br />![filter_views](../images/204/watsonxgov-l4_filter_views.png)
...
<br />![disable_views](../images/204/watsonxgov-l4_disable_view.png)
...
Congrats this is the end of lab 204!
