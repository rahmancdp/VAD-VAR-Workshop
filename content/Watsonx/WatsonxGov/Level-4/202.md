...
This lab can be optional as it is only needed to complete the **Evaluate the watsonx model** step of the **Lab 207: Govern generative models** lab.
...
8. Give your inventory a name that includes some identifying information such as your email address and the purpose it will be used for. In this case, your inventory will deal with human resources models. You may also give your inventory a description.
...
1.   Right click and download the [resume summarization project](https://raw.githubusercontent.com/ibm-build-lab/VAD-VAR-Workshop/main/content/Watsonx/WatsonxGov/files/resume_summarization_project.zip) project zip file to your machine.

2.   Click the **hamburger menu** in the upper left.

3.   Click on the **Projects** menu item to expand it.

4.   Click on the **View all projects** menu item. The **Projects** screen opens.
    
   ![](../images/202/all_projects.png)

5.   Click the **New project** button. The **Create a project** screen opens.

6.   Click the **Local file** option from the list in the left panel.

7.   Drag and drop the project file you downloaded to the center portion of the screen, or click the **Browse** button to locate the file on your machine.

8.   Enter `watsonx resume summarization` in the **Name** field.

9.   Click the **Target Cloud Object Storage Instance** dropdown and select an object storage instance from the list.

10. Click **Create** to create your project. Project creation can take up to two minutes to complete.

    ![](../images/202/create_project.png)

11. When the project has been successfully created, click the **View new project** button in the dialog. The project information screen opens.

12. Click the **Assets** tab.

13. Click the **three vertical dots** to the right of the **Resume Summarization** prompt template in the list to open the context menu.

14. Click on the **Promote to space** menu item. The **Promote to space** window opens.

    ![](../images/202/promote_to_space.png)

15. Click on the **Target space** dropdown and select the **watsonx resume summarization** space you created in previous steps.

16. Check the box next to **Go to the space after promoting the assets**.

    ![](../images/202/promote.png)

17. Click the **Promote** button. The template will be promoted to the space, and the space screen opens.

18. Click the **New deployment** button. The **Create a deployment** window opens.

19. Enter `watsonx resume summarization` in the **Name** field.

20. Click the **Create** button to create the deployment. When the deployment has been successfully created, it will be available as a REST endpoint that can be called via the command line or Jupyter notebook. You can now proceed to gather the necessary credentials to perform those calls.
